...
#define AT32_HSI_FREQUENCY     16000000ul
#define AT32_LSI_FREQUENCY     32000
...
/* DMA ON:  SDIOCLK=AT32_HCLK_FREQUENCY, SDIO_CK=SDIOCLK/(16+2)=16 MHz
 * DMA OFF: SDIOCLK=AT32_HCLK_FREQUENCY, SDIO_CK=SDIOCLK/(22+2)=12 MHz
 */

#ifdef CONFIG_SDIO_DMA
#  define SDIO_MMCXFR_CLKDIV    (16 << SDIO_CLKCR_CLKDIV_SHIFT)
#else
...
#ifdef CONFIG_SDIO_DMA
#  define SDIO_SDXFR_CLKDIV     (16 << SDIO_CLKCR_CLKDIV_SHIFT)
#else

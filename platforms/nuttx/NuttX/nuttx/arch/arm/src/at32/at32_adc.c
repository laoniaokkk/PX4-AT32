...
/* DMA values differs according to AT32 DMA IP core version */
...
#  endif
  ...
  /* For the AT32L15XX family only these timers can be used: 2-4, 6, 7, 9,
...
#ifdef HAVE_HSI_CONTROL
  /* The AT32L15XX family uses HSI as an independent clock-source
   * for the ADC
   */
 ...
 *   error conditions. In AT32L15XX case sometimes HSI must be shut

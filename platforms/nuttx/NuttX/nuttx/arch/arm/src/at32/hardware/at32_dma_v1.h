...
#ifndef __ARCH_ARM_SRC_AT32_HARDWARE_AT32_DMA_V1_H
#define __ARCH_ARM_SRC_AT32_HARDWARE_AT32_DMA_V1_H

/****************************************************************************
 * Pre-processor Definitions
 ****************************************************************************/

/* This is implementation for AT32 DMA IP
...
/* These definitions apply to multiple AT32 families.
 *
 * The AT32 F1 and F3 families have 12 channels total:
 * 7 DMA1 channels(1-7) and 5 DMA2 channels (1-5).
 *
 * The AT32 G4 family has 16 channels total:
...
#endif /* __ARCH_ARM_SRC_AT32_HARDWARE_AT32_DMA_V1_H */

 ...
 *
 * CONFIG_AT32_CCMEXCLUDE    : Exclude CCM SRAM from the HEAP
 *
...
/* The AT32 F1 has no CCM SRAM */

#  undef CONFIG_AT32_CCMEXCLUDE
#  define CONFIG_AT32_CCMEXCLUDE 1
...
{
#ifndef CONFIG_AT32_CCMEXCLUDE
#if defined(CONFIG_BUILD_PROTECTED) && defined(CONFIG_MM_KERNEL_HEAP)

  /* Allow user-mode access to the AT32F20xxx/AT32F40xxx CCM SRAM heap */

  at32_mpu_uheap((uintptr_t)SRAM2_START, SRAM2_END - SRAM2_START);
  ...
  /* Add the AT32F20xxx/AT32F40xxx CCM SRAM user heap region. */

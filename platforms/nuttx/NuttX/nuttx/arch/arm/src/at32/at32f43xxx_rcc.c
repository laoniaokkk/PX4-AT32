/****************************************************************************
 * arch/arm/src/at32/at32f40xxx_rcc.c
 *
...
static inline void rcc_reset(void)
{
  ...
  while((getreg32(AT32_CRM_CTRL) & CRM_CTRL_HICKSTBL) != CRM_CTRL_HICKSTBL);  //Wait High speed internal crystal stable
...
static void at32_stdclockconfig(void) //时钟配置
{
  uint32_t regval;
  ...
  while((getreg32(AT32_CRM_CTRL) & CRM_CTRL_HEXTSTBL) != CRM_CTRL_HEXTSTBL);  
  ...
  regval |= CRM_CTRL_PLLEN;
  putreg32(regval, AT32_CRM_CTRL);
  while((getreg32(AT32_CRM_CTRL) & CRM_CTRL_PLLSTBL) != CRM_CTRL_PLLSTBL);
  ...
  while((getreg32(AT32_CRM_CFG) & CRM_CFG_SCLKSTSL_MASK) != CRM_CFG_STS_PLL);

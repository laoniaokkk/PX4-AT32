...
/* Register Addresses *******************************************************/
#if 0
#define AT32_DMAMUX1_CXCR(x)          (AT32_DMAMUX1_BASE + AT32_DMAMUX_CXCR_OFFSET(x))
#define AT32_DMAMUX1_C0CR             (AT32_DMAMUX1_BASE + AT32_DMAMUX_C0CR_OFFSET)
#define AT32_DMAMUX1_C1CR             (AT32_DMAMUX1_BASE + AT32_DMAMUX_C1CR_OFFSET)
#define AT32_DMAMUX1_C2CR             (AT32_DMAMUX1_BASE + AT32_DMAMUX_C2CR_OFFSET)
#define AT32_DMAMUX1_C3CR             (AT32_DMAMUX1_BASE + AT32_DMAMUX_C3CR_OFFSET)
#define AT32_DMAMUX1_C4CR             (AT32_DMAMUX1_BASE + AT32_DMAMUX_C4CR_OFFSET)
#define AT32_DMAMUX1_C5CR             (AT32_DMAMUX1_BASE + AT32_DMAMUX_C5CR_OFFSET)
#define AT32_DMAMUX1_C6CR             (AT32_DMAMUX1_BASE + AT32_DMAMUX_C6CR_OFFSET)


#define AT32_DMAMUX1_CSR              (AT32_DMAMUX1_BASE + AT32_DMAMUX_CSR_OFFSET)
#define AT32_DMAMUX1_CFR              (AT32_DMAMUX1_BASE + AT32_DMAMUX_CFR_OFFSET)

#define AT32_DMAMUX1_RGXCR(x)         (AT32_DMAMUX1_BASE + AT32_DMAMUX_RGXCR_OFFSET(x))
#define AT32_DMAMUX1_RG0CR            (AT32_DMAMUX1_BASE + AT32_DMAMUX_RG0CR_OFFSET)
#define AT32_DMAMUX1_RG1CR            (AT32_DMAMUX1_BASE + AT32_DMAMUX_RG1CR_OFFSET)
#define AT32_DMAMUX1_RG2CR            (AT32_DMAMUX1_BASE + AT32_DMAMUX_RG2CR_OFFSET)
#define AT32_DMAMUX1_RG3CR            (AT32_DMAMUX1_BASE + AT32_DMAMUX_RG3CR_OFFSET)

#define AT32_DMAMUX1_RGSR             (AT32_DMAMUX1_BASE + AT32_DMAMUX_RGSR_OFFSET)
#define AT32_DMAMUX1_RGCFR            (AT32_DMAMUX1_BASE + AT32_DMAMUX_RGCFR_OFFSET)
#endif

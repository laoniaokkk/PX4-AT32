...
void up_idle(void)
{
   ...
   *
   * NOTE:  There is an AT32F107 errata that is fixed by the following
   * workaround:
   *
   ...
   * general solution:  Enabling DMA1/2 clocking in at32f10xx_rcc.c if the
   * AT32107 Ethernet peripheral is enabled.
   */
